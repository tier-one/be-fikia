...
export class CreateAssetTable1696708989144 implements MigrationInterface {
  name = 'CreateAssetTable1696708989144';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "asset_table" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "price" numeric(10,2) NOT NULL, "note" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "managerId" uuid, "fundId" uuid, CONSTRAINT "PK_f2abb8ff3b822f1dad2b7911d0e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
