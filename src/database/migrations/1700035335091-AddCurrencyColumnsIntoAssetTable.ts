...
export class AddCurrencyColumnsIntoAssetTable1700035335091
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "asset" ADD COLUMN IF NOT EXISTS "equityDetailsCurrency" character varying`);
        await queryRunner.query(`UPDATE "asset" SET "equityDetailsCurrency" = 'default_currency' WHERE "equityDetailsCurrency" IS NULL`);
