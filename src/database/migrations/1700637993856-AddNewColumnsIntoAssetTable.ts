...
export class AddNewColumnsIntoAssetTable1700637993856
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "asset" ALTER COLUMN "equityDetailsExchange" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "asset" ALTER COLUMN "equityDetailsExchange" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "asset" ALTER COLUMN "fixedIncomeDetailsFixedincometype" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "asset" ALTER COLUMN "fixedIncomeDetailsFixedincomename" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "asset" ALTER COLUMN "equityDetailsExchange" SET NOT NULL`,
    );
    await queryRunner.query(
