...
export class AddNewColumnsToTransactions1701078368558 implements MigrationInterface {
    name = 'AddNewColumnsToTransactions1701078368558'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "fund_transaction" DROP COLUMN "amount"`);
        await queryRunner.query(`ALTER TABLE "fund_transaction" DROP COLUMN "note"`);
        ...
        await queryRunner.query(`ALTER TABLE "fund_transaction" ALTER COLUMN "transactionType" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "fund_transaction" ALTER COLUMN "status" DROP DEFAULT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "fund_transaction" ALTER COLUMN "status" SET DEFAULT 'pending'`);
        await queryRunner.query(`ALTER TABLE "fund_transaction" ALTER COLUMN "transactionType" SET DEFAULT 'other'`);
        ...
        await queryRunner.query(`ALTER TABLE "fund_transaction" ADD "amount" numeric(15,2)`);
    }
